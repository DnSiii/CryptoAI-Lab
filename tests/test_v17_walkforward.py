...
import numpy as np
import pandas as pd
from test_v17_rebuild import sample
from cryptoai_v13.data import FuturesData
from cryptoai_v13.v17_walkforward import (
    ForecastSpec,feature_panel,forward_labels,purged_train_rows,
    walkforward_forecasts,forecasts_to_targets)
from cryptoai_v13.v17_relative import RelativeSpec,balance_sides,relative_targets,worthwhile_rebalance
...
class WalkforwardTests(unittest.TestCase):
    ...
    @unittest.skipUnless(find_spec('sklearn') and find_spec('threadpoolctl'),
                         'install requirements-v17-research.txt for model training tests')
