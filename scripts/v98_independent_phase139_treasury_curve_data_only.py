#!/usr/bin/env python3
"""V98 Independent Phase139: T10Y2Y DATA_ONLY integrity auditor.

Persisted output intentionally excludes observed values/signs/distribution/performance.
...
def acquire()->bytes:
    req=Request(URL,headers={"User-Agent":"CryptoAI-Lab-V98-Independent-Phase139/1.0"})
...
def audit(raw:bytes)->dict:
    ...
    return {
      ...
      "normalized_dates_sha256":digest,
...
def main():
    ...
    a["reproducibility"]={
      "second_normalized_dates_sha256":b["normalized_dates_sha256"],
      "identical_hash":a["normalized_dates_sha256"]==b["normalized_dates_sha256"],
