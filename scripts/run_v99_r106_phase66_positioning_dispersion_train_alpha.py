...
def main():
 ...
 cfg,data,raw,ex,guard,gross,quarantined,metadata=p1.r98.r36.v15_setup();idx=data.close.index;disp=pd.DataFrame(index=idx,columns=data.close.columns,dtype=float)
